...
public class ReferenceController : ControllerBase
{
    ...
    public IActionResult UpdateItem(string id, [FromBody] Reference updatedItem)
    {
        ...
        var existingItem = _referenceService.ReferenceExistsAsync();
