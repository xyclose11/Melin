...
namespace Melin.Server.Tests.Auth;

/// <summary>
/// Used to provide Authentication and Authorization services for testing
/// </summary>
public class TestAuthHandler : AuthenticationHandler<AuthenticationSchemeOptions>
{
    ...
    {
        var claims = new[] { new Claim(ClaimTypes.Name, "Melin Test User"), new Claim(ClaimTypes.Email, "MelinTestUser@test.com") };
